...
operator _OP_ (const RcppHoney::operand< T, T_ITER, T_RESULT > &lhs,           \
    const U &rhs) {                                                            \
                                                                               \
    return RcppHoney::make_binary_operator< T::NA >()(lhs,                     \
...
inline typename RcppHoney::traits::enable_if<                                  \
    (RcppHoney::hook< T >::value && RcppHoney::hook< U >::value                \
        && (((RcppHoney::hook< T >::FAMILY == 1                                \
            || RcppHoney::hook< U >::FAMILY == 1)                              \
                || RcppHoney::hook< T >::FAMILY                                \
                    != RcppHoney::hook< U >::FAMILY)                           \
...
RcppHoney::unary_operator<                                                     \
    T_ITER,                                                                    \
    RcppHoney::functors:: _FUNCTOR_ <T_ITER, T::NA >,                          \
    T::NA                                                                      \
>                                                                              \
operator _OP_ (const RcppHoney::operand< T, T_ITER, T_RESULT > &rhs) {         \
    return RcppHoney::make_unary_operator< T::NA >()(rhs,                      \
        RcppHoney::functors:: _FUNCTOR_ < T_ITER, T::NA >());                  \
}                                                                              \
                                                                               \
template< typename T >                                                         \
